...
require( ["js/qlik"], function ( qlik ) {
	...
	var app = qlik.openApp('653bbc69-972d-47d8-b267-0673ab80ad65', config);


	//get objects -- inserted here --
	app.getObject('QV06','HPzheHS');
	app.getObject('QV05','CH28');
	app.getObject('QV03','CH39');
	app.getObject('QV04','CH24');
	app.getObject('QV02','CH43');
	app.getObject('QV01','CH46');
